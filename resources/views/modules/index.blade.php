        ...
        <div
            ...
            <div class="flex flex-col gap-5">
                ...
                <div class="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 w-full">
                    ...
                    <button
                        class="bg-white/20 flex items-center backdrop-blur-md border border-white/30 text-white font-semibold px-4 py-2 rounded-lg hover:bg-white/30 transition whitespace-nowrap w-full sm:w-auto">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-5">
            @foreach ($modules as $module)
                ...
                <div
                    ...
                    <div class="flex flex-col gap-5">
                        <div
                            class="flex items-center justify-center {{ $colors['bg'] }} w-[60px] h-[60px] md:w-[70px] md:h-[70px] rounded-xl">
